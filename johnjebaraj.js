...
const songs = [
    ...
    // 9 song
    {
        id: "9",
        songName: 'Vaalaakamal <br> <div class="subtitle">John Jebaraj</div> ',
        poster: "img/johnjebaraj/9.jpg"
    },
    // 10 song
    {
        id: "10",
        songName: 'indian enru solvom <br> <div class="subtitle">John Jebaraj</div> ',
        poster: "img/johnjebaraj/10.jpg"
    },
    // 11 song
    {
        id: "11",
        songName: 'Naanga Vera Maari Bro<br> <div class="subtitle">John Jebaraj</div> ',
        poster: "img/johnjebaraj/11.jpg"
    }
  /*  // 12 song
    {
        id: "12",
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element)=>{
    element.addEventListener('click', (e)=>{
        ...
        music.src = `audio/johnjebaraj/${indexaj}.mp3`;
        poster_master_play.src =`img/johnjebaraj/${indexaj}.jpg`;
        music.play();
        download_music.href = `audio/johnjebaraj/${indexaj}.mp3`;
